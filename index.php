...
<head>
	...
	<title>VIT Jobs Centralised Job Portal</title>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>Find the most Exciting Job</h1>
					<p>Acting as as connecting bridge between job seeker and the orgsnization</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> VIT Job Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by CSB SY 23</a></li>
								</ul>
